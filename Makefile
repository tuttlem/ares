...
OBJS := boot/boot.o kernel/asm/isr.o init/main.o kernel/idt.o kernel/interrupt.o kernel/pit.o kernel/console.o kernel/string.o kernel/panic.o kernel/printf.o kernel/cpuid.o drivers/kbd.o
